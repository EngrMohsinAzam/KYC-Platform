...
import { checkBNBBalance, submitKYCVerification, isMetaMaskInstalled, getNetworkInfo, connectWallet, checkKYCStatus } from '@/app/(public)/wallet/web3'
...
export default function ConfirmBlockstamp() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      try {
        const { getNetworkInfo } = await import('@/app/(public)/wallet/web3')
      ...
      const { getProviderAndSigner } = await import('@/app/(public)/wallet/web3')
