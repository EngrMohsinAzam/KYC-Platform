...
const RANGE_OPTIONS: { id: MonthlyRange; label: string }[] = [
  { id: 'less_1k', label: 'Less than $1,000 USD' },
  { id: '1k_10k', label: '$1,000 - $9,999 USD' },
  { id: '10k_100k', label: '$10,000 - $99,999 USD' },
  { id: '100k_1m', label: '$100,000 - $999,999 USD' },
  { id: '1m_plus', label: '$1,000,000 USD or more' },
]
...
export default function MonthlyActivityPage() {
  ...
  return (
    <div className="min-h-screen h-[100dvh] md:h-screen overflow-hidden bg-[#FFFFFF] flex flex-col">
      <VerifyMobileBackRow onBack={() => router.push('/verify/investment-source')} />
      ...
      <main className="flex-1 flex flex-col items-start md:items-center md:justify-center px-4 pt-3 pb-28 md:pt-6 md:pb-6 md:min-h-0 min-h-0 overflow-hidden md:overflow-visible">
        ...
        <div className="w-full max-w-[760px] md:max-w-[680px] md:bg-[#FFFFFF] md:border-[1.5px] md:border-[#E8E8E9] md:rounded-[14px] md:px-5 md:py-4 md:flex md:flex-col">
          ...
          <h2 className="md:hidden font-sans text-[24px] leading-[1.3] font-bold text-[#000000] mb-2">
            How much money do you think you&apos;ll deposit and withdraw in a month?
          </h2>
          {/* Desktop label */}
          <label className="hidden md:block font-sans text-[20px] font-bold leading-[100%] tracking-[0%] text-[#000000] mb-2">
            How much money, you&apos;ll deposit and withdraw in a month?
          </label>
          ...
          <div className="flex flex-col gap-[1px]">
            {RANGE_OPTIONS.map((opt, index) => {
              ...
              const isLast = index === RANGE_OPTIONS.length - 1
          ...
          <div className="hidden md:block mt-6">
            ...
            <button
              type="button"
              onClick={() => router.push('/verify/investment-source')}
