...
const WEALTH_OPTIONS: { id: SourceOfWealth; label: string; icon: string }[] = [
  { id: 'salary', label: 'Salary', icon: '/source-of-wealth/salary.svg' },
  { id: 'self_employed', label: 'Self-employed', icon: '/source-of-wealth/self-employed.svg' },
  { id: 'retirement_saving', label: 'Retirement Savings/Pension', icon: '/source-of-wealth/retirement-saving.svg' },
  { id: 'inheritance', label: 'Inheritance', icon: '/source-of-wealth/inheritance.svg' },
  { id: 'investments', label: 'Investments', icon: '/source-of-wealth/investments.svg' },
  { id: 'other', label: 'Other', icon: '/source-of-wealth/other.svg' },
]
      ...
      <main className="flex-1 flex flex-col items-start md:items-center md:justify-center px-4 pt-3 pb-28 md:pt-6 md:pb-6 md:min-h-0 min-h-0 overflow-hidden md:overflow-visible">
        ...
        <div className="w-full max-w-[760px] md:max-w-[680px] md:bg-[#FFFFFF] md:border-[1.5px] md:border-[#E8E8E9] md:rounded-[14px] md:px-5 md:py-4 md:flex md:flex-col md:max-h-[min(623px,calc(100dvh-140px))]">
          ...
          <h2 className="md:hidden font-sans text-[20px] font-bold leading-[100%] tracking-[0%] text-[#000000] mb-2">
            What are your sources of wealth?
          </h2>
          {/* Desktop label */}
          ...
          <p className="font-sans text-[18px] font-normal leading-[100%] tracking-[0%] text-[#545454] mb-4">
            This helps us understand how you earned or grew your overall wealth.
          </p>
          ...
          <div className="md:flex-1 md:overflow-y-auto md:min-h-0">
            <div className="flex flex-col gap-[1px]">
              {WEALTH_OPTIONS.map((opt, index) => {
                ...
                const isLast = index === WEALTH_OPTIONS.length - 1
                ...
                return (
                  ...
                  >
                    <span className="flex items-center gap-3">
                      <span className="inline-flex h-7 w-7 items-center justify-center flex-shrink-0">
