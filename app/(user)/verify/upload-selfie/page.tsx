  ...
  const getProgressColorHex = () => {
    ...
    return (
      <div className="min-h-screen h-[100dvh] md:h-screen bg-black flex flex-col overflow-hidden">
        ...
        <main className="flex-1 flex flex-col items-center justify-center min-h-0 overflow-hidden px-4 pt-7 pb-[92px] md:py-10">
          <h1 className="text-white text-[18px] md:text-[20px] font-semibold text-center mb-7">
          ...
          */}
          <div className="relative flex-shrink-0 overflow-visible -mt-3 md:mt-0" style={{ width: isMobile ? 330 : 300, height: isMobile ? 330 : 300 }}>
