...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Check if it's an email format, otherwise treat as username
    const isEmail = validateEmail(email)
    
    setLoading(true)
    try {
      // TODO: Implement forgot password API call to send OTP
      console.log('Forgot password request:', { email, isEmail })
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-lg shadow-2xl border border-gray-200 p-8">
            ...
            <h1 className="text-2xl font-semibold text-gray-900 mb-2 text-center">Reset your password</h1>
            <p className="text-sm text-gray-600 mb-6 text-center">
              Enter your username or email and we&apos;ll send you a link to your email address with instructions on how to reset your password.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent ${
